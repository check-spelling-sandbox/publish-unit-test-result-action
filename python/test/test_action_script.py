...
class Test(unittest.TestCase):
    ...
    def test_parse_files_no_matches(self):
        ...
        gha.warning.assert_has_calls([
            ...
            mock.call(f'https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#running-with-absolute-paths'),
        ...
        with tempfile.TemporaryDirectory() as path:
            ...
            gha.warning.assert_has_calls([
                mock.call('This action is running on a pull_request event for a fork repository. '
                          ...
                          f'see https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}'
